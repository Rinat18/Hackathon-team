        ...
        >
          <SwiperSlide className="swiper1">
            <div className="carel">
              <img src={logo} alt="" />
              <p>
                Знаменитая серия гоночных компьютерных игр, <br /> созданная
                компанией Electronic Arts. <br /> Игры серии основываются на
                уличных гонках <br /> с использованием различных спортивных{" "}
                <br />
                автомобилей.
              </p>
              <span>
